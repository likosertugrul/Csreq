...
function LetterModal({ letter, host, onClose }: { letter: string; host: string; onClose: () => void }) {
    ...
    >
      ...
      >
        <div style={{
          ...
          <div>
            <p style={{ fontSize: "0.68rem", color: "var(--color-amber)", letterSpacing: "0.12em", textTransform: "uppercase", fontWeight: 500, marginBottom: "2px" }}>Example letter</p>
    ...
    <>
      ...
      <section style={{ maxWidth: "1100px", margin: "0 auto", padding: "6rem 1.5rem 5rem" }}>
        <div className="animate-fade-up">
          ...
          <h1 style={{
            ...
            Write the perfect<br />host message.<br />
            <em style={{ fontStyle: "italic", color: "var(--color-ink-muted)" }}>In seconds.</em>
          </h1>
      ...
      <section style={{ maxWidth: "1100px", margin: "0 auto", padding: "5rem 1.5rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2rem" }}>
          {[
            ...
            { n: "03", title: "Read your letter", body: "A personalized, human-sounding letter appears in seconds. Edit it freely, then copy and send." },
          ].map(step => (
      ...
      <section style={{ maxWidth: "1100px", margin: "0 auto", padding: "5rem 1.5rem" }}>
        <div style={{ marginBottom: "3.5rem" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: 300, color: "var(--color-ink)", letterSpacing: "-0.02em", lineHeight: 1.15, maxWidth: "600px" }}>
            ChatGPT writes a letter.<br />
            <em style={{ fontStyle: "italic", color: "var(--color-ink-muted)" }}>This one might get a reply.</em>
          </h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
          ...
          <div style={{ border: "1px solid var(--color-edge)", borderRadius: "20px", padding: "1.75rem", background: "rgba(255,255,255,0.015)" }}>
            <div style={{ marginBottom: "1.25rem" }}>
              <p style={{ fontSize: "0.68rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--color-ink-muted)", fontWeight: 600, marginBottom: "0.5rem" }}>The problem</p>
              <h3 style={{ fontFamily: "var(--font-serif)", fontSize: "1.1rem", fontWeight: 400, color: "var(--color-ink)" }}>LLMs have a writing fingerprint</h3>
            </div>
            <p style={{ fontSize: "0.83rem", color: "var(--color-ink-muted)", lineHeight: 1.7, marginBottom: "1.25rem" }}>
            ...
            <div style={{ background: "rgba(0,0,0,0.2)", border: "1px solid var(--color-edge)", borderRadius: "12px", padding: "1rem", fontFamily: "var(--font-mono)", fontSize: "0.75rem", lineHeight: 1.8 }}>
              <p style={{ margin: "0 0 0.4rem", color: "var(--color-ink-muted)", fontSize: "0.65rem", letterSpacing: "0.08em", textTransform: "uppercase" }}>blocked in csreq</p>
              {[
            ...
            <p style={{ fontSize: "0.78rem", color: "var(--color-ink-muted)", marginTop: "1rem", lineHeight: 1.6 }}>
          ...
          <div style={{ border: "1px solid var(--color-edge)", borderRadius: "20px", padding: "1.75rem", background: "rgba(255,255,255,0.015)" }}>
            <div style={{ marginBottom: "1.25rem" }}>
              <p style={{ fontSize: "0.68rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--color-ink-muted)", fontWeight: 600, marginBottom: "0.5rem" }}>The problem</p>
              <h3 style={{ fontFamily: "var(--font-serif)", fontSize: "1.1rem", fontWeight: 400, color: "var(--color-ink)" }}>ChatGPT doesn't know CouchSurfing's rules</h3>
            </div>
            <p style={{ fontSize: "0.83rem", color: "var(--color-ink-muted)", lineHeight: 1.7, marginBottom: "1.25rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "12px", background: "rgba(220,60,60,0.06)", border: "1px solid rgba(220,60,60,0.15)", borderRadius: "10px", padding: "0.75rem 1rem" }}>
                ...
                <div>
                  <p style={{ fontSize: "0.72rem", color: "rgba(220,80,80,0.8)", fontWeight: 600, margin: "0 0 1px" }}>ChatGPT output</p>
                  <p style={{ fontSize: "0.78rem", color: "var(--color-ink-muted)", margin: 0 }}>1,340 chars — host sees first 995, letter ends mid-sentence</p>
                </div>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: "12px", background: "var(--color-amber-dim)", border: "1px solid rgba(224,120,48,0.2)", borderRadius: "10px", padding: "0.75rem 1rem" }}>
                ...
                <div>
                  <p style={{ fontSize: "0.72rem", color: "var(--color-amber)", fontWeight: 600, margin: "0 0 1px" }}>csreq output</p>
                  <p style={{ fontSize: "0.78rem", color: "var(--color-ink-muted)", margin: 0 }}>874 chars — ends on a real sentence, nothing cut</p>
                </div>
              </div>
            </div>
            <p style={{ fontSize: "0.78rem", color: "var(--color-ink-muted)", marginTop: "1rem", lineHeight: 1.6 }}>
          ...
          {/* Card 3: Profile reading */}
          <div style={{ border: "1px solid var(--color-edge)", borderRadius: "20px", padding: "1.75rem", background: "rgba(255,255,255,0.015)" }}>
            <div style={{ marginBottom: "1.25rem" }}>
              <p style={{ fontSize: "0.68rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--color-ink-muted)", fontWeight: 600, marginBottom: "0.5rem" }}>The problem</p>
              <h3 style={{ fontFamily: "var(--font-serif)", fontSize: "1.1rem", fontWeight: 400, color: "var(--color-ink)" }}>Generic beats specific every time — in the wrong direction</h3>
            </div>
            <p style={{ fontSize: "0.83rem", color: "var(--color-ink-muted)", lineHeight: 1.7, marginBottom: "1.25rem" }}>
            ...
            <p style={{ fontSize: "0.83rem", color: "var(--color-ink-muted)", lineHeight: 1.7 }}>
          ...
          {/* Card 4: Host warnings */}
          <div style={{ border: "1px solid var(--color-edge)", borderRadius: "20px", padding: "1.75rem", background: "rgba(255,255,255,0.015)" }}>
            <div style={{ marginBottom: "1.25rem" }}>
              <p style={{ fontSize: "0.68rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--color-ink-muted)", fontWeight: 600, marginBottom: "0.5rem" }}>The problem</p>
              <h3 style={{ fontFamily: "var(--font-serif)", fontSize: "1.1rem", fontWeight: 400, color: "var(--color-ink)" }}>LLMs don't read the fine print</h3>
            </div>
            <p style={{ fontSize: "0.83rem", color: "var(--color-ink-muted)", lineHeight: 1.7, marginBottom: "1.25rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem" }}>
              {[
                { icon: "⚑", text: "Female guests only" },
                { icon: "⚑", text: "Minimum 3-night stay" },
                { icon: "⚑", text: "No guests until March" },
              ].map(w => (
                <div key={w.text} style={{ display: "flex", gap: "10px", alignItems: "center", background: "rgba(224,120,48,0.06)", border: "1px solid rgba(224,120,48,0.15)", borderRadius: "8px", padding: "0.6rem 0.9rem" }}>
                  <span style={{ color: "var(--color-amber)", fontSize: "0.85rem" }}>{w.icon}</span>
                  <span style={{ fontSize: "0.78rem", color: "var(--color-ink-muted)" }}>{w.text} — detected from profile</span>
                </div>
              ))}
            </div>
            <p style={{ fontSize: "0.78rem", color: "var(--color-ink-muted)", marginTop: "1rem", lineHeight: 1.6 }}>
      ...
      <section style={{ maxWidth: "1100px", margin: "0 auto", padding: "5rem 1.5rem" }}>
        <div style={{ marginBottom: "3rem" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: 300, color: "var(--color-ink)", letterSpacing: "-0.02em", lineHeight: 1.15 }}>
            Built for real travelers,<br />
            <em style={{ fontStyle: "italic", color: "var(--color-ink-muted)" }}>not templates.</em>
          </h2>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1.25rem", alignItems: "start" }}>
          ...
          <div style={{ border: "1px solid var(--color-edge)", borderRadius: "20px", padding: "1.75rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: "4px", marginBottom: "0.35rem" }}>
              <span style={{ fontFamily: "var(--font-serif)", fontSize: "2.5rem", fontWeight: 300, color: "var(--color-ink)" }}>$0</span>
            </div>
            <p style={{ fontSize: "0.78rem", color: "var(--color-ink-muted)", marginBottom: "1.5rem" }}>No credit card required</p>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem", marginBottom: "1.75rem" }}>
              {["5 letters total", "All languages", "Full editor", "Host warnings"].map(f => (
            ...
            <Link
              ...
              style={{
                ...
                border: "1px solid var(--color-edge-hi)", borderRadius: "12px",
                color: "var(--color-ink)", fontSize: "0.85rem", fontWeight: 500, textDecoration: "none",
                transition: "all 0.2s",
              }}
            >
              Get started
          ...
          {/* Monthly */}
          <div style={{ border: "1px solid var(--color-edge)", borderRadius: "20px", padding: "1.75rem" }}>
            <p style={{ fontSize: "0.72rem", color: "var(--color-ink-muted)", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "0.75rem" }}>Monthly</p>
            <div style={{ display: "flex", alignItems: "baseline", gap: "4px", marginBottom: "0.35rem" }}>
              <span style={{ fontFamily: "var(--font-serif)", fontSize: "2.5rem", fontWeight: 300, color: "var(--color-ink)" }}>$5</span>
              <span style={{ fontSize: "0.8rem", color: "var(--color-ink-muted)" }}>/month</span>
            </div>
            <p style={{ fontSize: "0.78rem", color: "var(--color-ink-muted)", marginBottom: "1.5rem" }}>Cancel anytime</p>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem", marginBottom: "1.75rem" }}>
              {["Unlimited letters", "All languages", "Full editor", "Host warnings", "Priority support"].map(f => (
                <div key={f} style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                  <span style={{ color: "var(--color-amber)", fontSize: "0.7rem" }}>✓</span>
                  <span style={{ fontSize: "0.82rem", color: "var(--color-ink-muted)" }}>{f}</span>
                </div>
          ...
          <div style={{
            border: "1px solid rgba(224,120,48,0.45)", borderRadius: "20px", padding: "1.75rem",
            background: "var(--color-amber-dim)", position: "relative",
          }}>
            <div style={{
              position: "absolute", top: "-12px", left: "50%", transform: "translateX(-50%)",
              background: "linear-gradient(135deg, var(--color-amber) 0%, var(--color-amber-hi) 100%)",
              color: "#fff", fontSize: "0.6rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase",
              padding: "3px 12px", borderRadius: "100px",
              boxShadow: "0 2px 8px rgba(224,120,48,0.4)",
            }}>
              Best value
            </div>
            <p style={{ fontSize: "0.72rem", color: "var(--color-amber)", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "0.75rem", fontWeight: 600 }}>Lifetime</p>
            <div style={{ display: "flex", alignItems: "baseline", gap: "4px", marginBottom: "0.35rem" }}>
              <span style={{ fontFamily: "var(--font-serif)", fontSize: "2.5rem", fontWeight: 300, color: "var(--color-ink)" }}>$25</span>
            </div>
            <p style={{ fontSize: "0.78rem", color: "var(--color-ink-muted)", marginBottom: "1.5rem" }}>One payment, forever</p>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem", marginBottom: "1.75rem" }}>
              {["Unlimited letters", "All languages", "Full editor", "Host warnings", "Priority support", "All future features"].map(f => (
                <div key={f} style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                  <span style={{ color: "var(--color-amber)", fontSize: "0.7rem" }}>✓</span>
                  <span style={{ fontSize: "0.82rem", color: "var(--color-ink-muted)" }}>{f}</span>
                </div>
            ...
            <Link
              ...
              style={{
                ...
                textDecoration: "none", boxShadow: "0 3px 12px rgba(224,120,48,0.3)", transition: "all 0.2s",
              }}
            >
              Get lifetime access →
            </Link>
      ...
      <footer style={{ borderTop: "1px solid var(--color-edge)", padding: "2rem 1.5rem" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
          <span style={{ fontFamily: "var(--font-serif)", fontSize: "1rem", fontWeight: 500, color: "var(--color-ink-muted)" }}>
            csreq
          </span>
          <p style={{ fontSize: "0.75rem", color: "var(--color-ink-muted)" }}>
            © 2025 csreq. Write better couch requests.
          </p>
        </div>
      </footer>
    </>
